...
<html lang="en">
  ...
  <body style="background-image: url('../../src/register.png'); background-repeat: no-repeat; background-attachment: fixed; background-position: center;">
    <nav class="nav">
      ...
      <div class="nav1">
      <ul>
      <li><a href="../Geust user session/index.php">Home</a></li>
		<li><a href="../Geust user session/index-service.php">Services</a></li>
		<li><a href="../Geust user session/aboutus.php">About</a></li>
		<li><a href="../Geust user session/productindex.php">Shop</a></li>
