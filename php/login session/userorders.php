...
<div id="info" style="height:100%;width:70%;background-image:url('../../src/Useracc.jpg')">
	...
	<br><br><br><br><h1 style="align-items=center;color:black;">Orders</h1>
	<table >
  <tr>
    <th>Order ID</th>
    <th>Product</th>
  ...
  <tr>
  <?php
      $select_user3= mysqli_query($conn, "SELECT * FROM `orders` WHERE CID ='$user_id'") or die('query failed');
	  while($row=mysqli_fetch_assoc($select_user3)){
